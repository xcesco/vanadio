...
@BindType()
@BindXmlType public class JasperReport {
    @Bind(order = 10)
    ...
    @Bind(order = 260)
    @BindXml(xmlType = com.abubusoft.kripton.xml.XmlType.ATTRIBUTE)
    ...
    public void setPropertyExpression(List<DatasetPropertyExpressionType> propertyExpression) {
    ...
    public void setReportFont(List<ReportFont> reportFont) {
    ...
    public void setSubDataset(List<SubDataset> subDataset) {
        this.subDataset = subDataset;
    }

    public void setScriptlet(List<Scriptlet> scriptlet) {
